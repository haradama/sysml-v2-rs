...
impl ElementKind {
    ...
    pub fn own_features(self) -> &'static [FeatureMeta] {
        match self {
            ElementKind::AcceptActionUsage => &[
                FeatureMeta { name: "receiverArgument", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
                FeatureMeta { name: "payloadParameter", ty: FeatureType::Class(ElementKind::ReferenceUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "payloadArgument", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
            ],
            ElementKind::ActionDefinition => &[
                FeatureMeta { name: "action", ty: FeatureType::Class(ElementKind::ActionUsage), many: true, derived: true, default: None },
            ],
            ElementKind::ActionUsage => &[
                FeatureMeta { name: "actionDefinition", ty: FeatureType::Class(ElementKind::Behavior), many: true, derived: true, default: None },
            ],
            ElementKind::ActorMembership => &[
                FeatureMeta { name: "ownedActorParameter", ty: FeatureType::Class(ElementKind::PartUsage), many: false, derived: true, default: None },
            ],
            ElementKind::AllocationDefinition => &[
                FeatureMeta { name: "allocation", ty: FeatureType::Class(ElementKind::AllocationUsage), many: true, derived: true, default: None },
            ],
            ElementKind::AllocationUsage => &[
                FeatureMeta { name: "allocationDefinition", ty: FeatureType::Class(ElementKind::AllocationDefinition), many: true, derived: true, default: None },
            ],
            ElementKind::AnalysisCaseDefinition => &[
                FeatureMeta { name: "resultExpression", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
            ],
            ElementKind::AnalysisCaseUsage => &[
                FeatureMeta { name: "analysisCaseDefinition", ty: FeatureType::Class(ElementKind::AnalysisCaseDefinition), many: false, derived: true, default: None },
                FeatureMeta { name: "resultExpression", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
            ],
            ElementKind::AnnotatingElement => &[
                FeatureMeta { name: "annotatedElement", ty: FeatureType::Class(ElementKind::Element), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedAnnotatingRelationship", ty: FeatureType::Class(ElementKind::Annotation), many: true, derived: true, default: None },
                FeatureMeta { name: "owningAnnotatingRelationship", ty: FeatureType::Class(ElementKind::Annotation), many: false, derived: true, default: None },
                FeatureMeta { name: "annotation", ty: FeatureType::Class(ElementKind::Annotation), many: true, derived: true, default: None },
            ],
            ElementKind::Annotation => &[
                FeatureMeta { name: "annotatingElement", ty: FeatureType::Class(ElementKind::AnnotatingElement), many: false, derived: true, default: None },
                FeatureMeta { name: "annotatedElement", ty: FeatureType::Class(ElementKind::Element), many: false, derived: false, default: None },
                FeatureMeta { name: "owningAnnotatedElement", ty: FeatureType::Class(ElementKind::Element), many: false, derived: true, default: None },
                FeatureMeta { name: "owningAnnotatingElement", ty: FeatureType::Class(ElementKind::AnnotatingElement), many: false, derived: true, default: None },
                FeatureMeta { name: "ownedAnnotatingElement", ty: FeatureType::Class(ElementKind::AnnotatingElement), many: false, derived: true, default: None },
            ],
            ElementKind::AssertConstraintUsage => &[
                FeatureMeta { name: "assertedConstraint", ty: FeatureType::Class(ElementKind::ConstraintUsage), many: false, derived: true, default: None },
            ],
            ElementKind::AssignmentActionUsage => &[
                FeatureMeta { name: "targetArgument", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
                FeatureMeta { name: "valueExpression", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
                FeatureMeta { name: "referent", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
            ],
            ElementKind::Association => &[
                FeatureMeta { name: "relatedType", ty: FeatureType::Class(ElementKind::Type), many: true, derived: true, default: None },
                FeatureMeta { name: "sourceType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: true, default: None },
                FeatureMeta { name: "targetType", ty: FeatureType::Class(ElementKind::Type), many: true, derived: true, default: None },
                FeatureMeta { name: "associationEnd", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
            ],
            ElementKind::AssociationStructure => &[
            ],
            ElementKind::AttributeDefinition => &[
            ...
            ElementKind::AttributeUsage => &[
                FeatureMeta { name: "attributeDefinition", ty: FeatureType::Class(ElementKind::DataType), many: true, derived: true, default: None },
                FeatureMeta { name: "isReference", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: true, default: Some(true) },
            ],
            ElementKind::Behavior => &[
                FeatureMeta { name: "step", ty: FeatureType::Class(ElementKind::Step), many: true, derived: true, default: None },
                FeatureMeta { name: "parameter", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
            ],
            ElementKind::BindingConnector => &[
            ],
            ElementKind::BindingConnectorAsUsage => &[
            ...
            ElementKind::BooleanExpression => &[
                FeatureMeta { name: "predicate", ty: FeatureType::Class(ElementKind::Predicate), many: false, derived: true, default: None },
            ],
            ElementKind::CalculationDefinition => &[
                FeatureMeta { name: "calculation", ty: FeatureType::Class(ElementKind::CalculationUsage), many: true, derived: true, default: None },
            ],
            ElementKind::CalculationUsage => &[
                FeatureMeta { name: "calculationDefinition", ty: FeatureType::Class(ElementKind::Function), many: false, derived: true, default: None },
            ],
            ElementKind::CaseDefinition => &[
                FeatureMeta { name: "objectiveRequirement", ty: FeatureType::Class(ElementKind::RequirementUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "subjectParameter", ty: FeatureType::Class(ElementKind::Usage), many: false, derived: true, default: None },
                FeatureMeta { name: "actorParameter", ty: FeatureType::Class(ElementKind::PartUsage), many: true, derived: true, default: None },
            ],
            ElementKind::CaseUsage => &[
                FeatureMeta { name: "objectiveRequirement", ty: FeatureType::Class(ElementKind::RequirementUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "caseDefinition", ty: FeatureType::Class(ElementKind::CaseDefinition), many: false, derived: true, default: None },
                FeatureMeta { name: "subjectParameter", ty: FeatureType::Class(ElementKind::Usage), many: false, derived: true, default: None },
                FeatureMeta { name: "actorParameter", ty: FeatureType::Class(ElementKind::PartUsage), many: true, derived: true, default: None },
            ],
            ElementKind::Class => &[
            ...
            ElementKind::Classifier => &[
                FeatureMeta { name: "ownedSubclassification", ty: FeatureType::Class(ElementKind::Subclassification), many: true, derived: true, default: None },
            ],
            ElementKind::CollectExpression => &[
                FeatureMeta { name: "operator", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
            ],
            ElementKind::Comment => &[
                FeatureMeta { name: "locale", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
                FeatureMeta { name: "body", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
            ],
            ElementKind::ConcernDefinition => &[
            ],
            ElementKind::ConcernUsage => &[
                FeatureMeta { name: "concernDefinition", ty: FeatureType::Class(ElementKind::ConcernDefinition), many: false, derived: true, default: None },
            ],
            ElementKind::ConjugatedPortDefinition => &[
                FeatureMeta { name: "originalPortDefinition", ty: FeatureType::Class(ElementKind::PortDefinition), many: false, derived: true, default: None },
                FeatureMeta { name: "ownedPortConjugator", ty: FeatureType::Class(ElementKind::PortConjugation), many: false, derived: true, default: None },
            ],
            ElementKind::ConjugatedPortTyping => &[
                FeatureMeta { name: "portDefinition", ty: FeatureType::Class(ElementKind::PortDefinition), many: false, derived: true, default: None },
                FeatureMeta { name: "conjugatedPortDefinition", ty: FeatureType::Class(ElementKind::ConjugatedPortDefinition), many: false, derived: false, default: None },
            ],
            ElementKind::Conjugation => &[
                FeatureMeta { name: "originalType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: false, default: None },
                FeatureMeta { name: "conjugatedType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: false, default: None },
                FeatureMeta { name: "owningType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: true, default: None },
            ],
            ElementKind::ConnectionDefinition => &[
                FeatureMeta { name: "connectionEnd", ty: FeatureType::Class(ElementKind::Usage), many: true, derived: true, default: None },
                FeatureMeta { name: "isSufficient", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(true) },
            ],
            ElementKind::ConnectionUsage => &[
                FeatureMeta { name: "connectionDefinition", ty: FeatureType::Class(ElementKind::AssociationStructure), many: true, derived: true, default: None },
            ],
            ElementKind::Connector => &[
                FeatureMeta { name: "relatedFeature", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
                FeatureMeta { name: "association", ty: FeatureType::Class(ElementKind::Association), many: true, derived: true, default: None },
                FeatureMeta { name: "connectorEnd", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
                FeatureMeta { name: "sourceFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
                FeatureMeta { name: "targetFeature", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
                FeatureMeta { name: "defaultFeaturingType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: true, default: None },
            ],
            ElementKind::ConnectorAsUsage => &[
            ],
            ElementKind::ConstraintDefinition => &[
            ...
            ElementKind::ConstraintUsage => &[
                FeatureMeta { name: "constraintDefinition", ty: FeatureType::Class(ElementKind::Predicate), many: false, derived: true, default: None },
            ],
            ElementKind::ConstructorExpression => &[
            ],
            ElementKind::ControlNode => &[
            ...
            ElementKind::CrossSubsetting => &[
                FeatureMeta { name: "crossedFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: false, default: None },
                FeatureMeta { name: "crossingFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
            ],
            ElementKind::DataType => &[
            ],
            ElementKind::DecisionNode => &[
            ...
            ElementKind::Definition => &[
                FeatureMeta { name: "isVariation", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "variant", ty: FeatureType::Class(ElementKind::Usage), many: true, derived: true, default: None },
                FeatureMeta { name: "variantMembership", ty: FeatureType::Class(ElementKind::VariantMembership), many: true, derived: true, default: None },
                FeatureMeta { name: "usage", ty: FeatureType::Class(ElementKind::Usage), many: true, derived: true, default: None },
                FeatureMeta { name: "directedUsage", ty: FeatureType::Class(ElementKind::Usage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedUsage", ty: FeatureType::Class(ElementKind::Usage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedReference", ty: FeatureType::Class(ElementKind::ReferenceUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedAttribute", ty: FeatureType::Class(ElementKind::AttributeUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedEnumeration", ty: FeatureType::Class(ElementKind::EnumerationUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedOccurrence", ty: FeatureType::Class(ElementKind::OccurrenceUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedItem", ty: FeatureType::Class(ElementKind::ItemUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedPart", ty: FeatureType::Class(ElementKind::PartUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedPort", ty: FeatureType::Class(ElementKind::PortUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedConnection", ty: FeatureType::Class(ElementKind::ConnectorAsUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedFlow", ty: FeatureType::Class(ElementKind::FlowUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedInterface", ty: FeatureType::Class(ElementKind::InterfaceUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedAllocation", ty: FeatureType::Class(ElementKind::AllocationUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedAction", ty: FeatureType::Class(ElementKind::ActionUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedState", ty: FeatureType::Class(ElementKind::StateUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedTransition", ty: FeatureType::Class(ElementKind::TransitionUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedCalculation", ty: FeatureType::Class(ElementKind::CalculationUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedConstraint", ty: FeatureType::Class(ElementKind::ConstraintUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedRequirement", ty: FeatureType::Class(ElementKind::RequirementUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedConcern", ty: FeatureType::Class(ElementKind::ConcernUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedCase", ty: FeatureType::Class(ElementKind::CaseUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedAnalysisCase", ty: FeatureType::Class(ElementKind::AnalysisCaseUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedVerificationCase", ty: FeatureType::Class(ElementKind::VerificationCaseUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedUseCase", ty: FeatureType::Class(ElementKind::UseCaseUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedView", ty: FeatureType::Class(ElementKind::ViewUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedViewpoint", ty: FeatureType::Class(ElementKind::ViewpointUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedRendering", ty: FeatureType::Class(ElementKind::RenderingUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedMetadata", ty: FeatureType::Class(ElementKind::MetadataUsage), many: true, derived: true, default: None },
            ],
            ElementKind::Dependency => &[
                FeatureMeta { name: "client", ty: FeatureType::Class(ElementKind::Element), many: true, derived: false, default: None },
                FeatureMeta { name: "supplier", ty: FeatureType::Class(ElementKind::Element), many: true, derived: false, default: None },
            ],
            ElementKind::Differencing => &[
                FeatureMeta { name: "typeDifferenced", ty: FeatureType::Class(ElementKind::Type), many: false, derived: true, default: None },
                FeatureMeta { name: "differencingType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: false, default: None },
            ],
            ElementKind::Disjoining => &[
                FeatureMeta { name: "typeDisjoined", ty: FeatureType::Class(ElementKind::Type), many: false, derived: false, default: None },
                FeatureMeta { name: "disjoiningType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: false, default: None },
                FeatureMeta { name: "owningType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: true, default: None },
            ],
            ElementKind::Documentation => &[
                FeatureMeta { name: "documentedElement", ty: FeatureType::Class(ElementKind::Element), many: false, derived: true, default: None },
            ],
            ElementKind::Element => &[
                FeatureMeta { name: "owningMembership", ty: FeatureType::Class(ElementKind::OwningMembership), many: false, derived: true, default: None },
                FeatureMeta { name: "owningRelationship", ty: FeatureType::Class(ElementKind::Relationship), many: false, derived: false, default: None },
                FeatureMeta { name: "owningNamespace", ty: FeatureType::Class(ElementKind::Namespace), many: false, derived: true, default: None },
                FeatureMeta { name: "elementId", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
                FeatureMeta { name: "ownedRelationship", ty: FeatureType::Class(ElementKind::Relationship), many: true, derived: false, default: None },
                FeatureMeta { name: "owner", ty: FeatureType::Class(ElementKind::Element), many: false, derived: true, default: None },
                FeatureMeta { name: "ownedElement", ty: FeatureType::Class(ElementKind::Element), many: true, derived: true, default: None },
                FeatureMeta { name: "documentation", ty: FeatureType::Class(ElementKind::Documentation), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedAnnotation", ty: FeatureType::Class(ElementKind::Annotation), many: true, derived: true, default: None },
                FeatureMeta { name: "textualRepresentation", ty: FeatureType::Class(ElementKind::TextualRepresentation), many: true, derived: true, default: None },
                FeatureMeta { name: "aliasIds", ty: FeatureType::Data(PrimitiveType::String), many: true, derived: false, default: None },
                FeatureMeta { name: "declaredShortName", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
                FeatureMeta { name: "declaredName", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
                FeatureMeta { name: "shortName", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: true, default: None },
                FeatureMeta { name: "name", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: true, default: None },
                FeatureMeta { name: "qualifiedName", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: true, default: None },
                FeatureMeta { name: "isImpliedIncluded", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "isLibraryElement", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: true, default: Some(false) },
            ],
            ElementKind::ElementFilterMembership => &[
                FeatureMeta { name: "condition", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
            ],
            ElementKind::EndFeatureMembership => &[
                FeatureMeta { name: "ownedMemberFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
            ],
            ElementKind::EnumerationDefinition => &[
                FeatureMeta { name: "enumeratedValue", ty: FeatureType::Class(ElementKind::EnumerationUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "isVariation", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(true) },
            ],
            ElementKind::EnumerationUsage => &[
                FeatureMeta { name: "enumerationDefinition", ty: FeatureType::Class(ElementKind::EnumerationDefinition), many: false, derived: true, default: None },
            ],
            ElementKind::EventOccurrenceUsage => &[
                FeatureMeta { name: "eventOccurrence", ty: FeatureType::Class(ElementKind::OccurrenceUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "isReference", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: true, default: Some(true) },
            ],
            ElementKind::ExhibitStateUsage => &[
                FeatureMeta { name: "exhibitedState", ty: FeatureType::Class(ElementKind::StateUsage), many: false, derived: true, default: None },
            ],
            ElementKind::Expose => &[
                FeatureMeta { name: "visibility", ty: FeatureType::Enumeration(EnumType::VisibilityKind), many: false, derived: false, default: None },
                FeatureMeta { name: "isImportAll", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(true) },
            ],
            ElementKind::Expression => &[
                FeatureMeta { name: "function", ty: FeatureType::Class(ElementKind::Function), many: false, derived: true, default: None },
                FeatureMeta { name: "result", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
                FeatureMeta { name: "isModelLevelEvaluable", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: true, default: Some(false) },
            ],
            ElementKind::Feature => &[
                FeatureMeta { name: "owningType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: true, default: None },
                FeatureMeta { name: "isUnique", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(true) },
                FeatureMeta { name: "isOrdered", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "type", ty: FeatureType::Class(ElementKind::Type), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedRedefinition", ty: FeatureType::Class(ElementKind::Redefinition), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedSubsetting", ty: FeatureType::Class(ElementKind::Subsetting), many: true, derived: true, default: None },
                FeatureMeta { name: "owningFeatureMembership", ty: FeatureType::Class(ElementKind::FeatureMembership), many: false, derived: true, default: None },
                FeatureMeta { name: "isComposite", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "isEnd", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "endOwningType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: true, default: None },
                FeatureMeta { name: "ownedTyping", ty: FeatureType::Class(ElementKind::FeatureTyping), many: true, derived: true, default: None },
                FeatureMeta { name: "featuringType", ty: FeatureType::Class(ElementKind::Type), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedTypeFeaturing", ty: FeatureType::Class(ElementKind::TypeFeaturing), many: true, derived: true, default: None },
                FeatureMeta { name: "isDerived", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "chainingFeature", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedFeatureInverting", ty: FeatureType::Class(ElementKind::FeatureInverting), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedFeatureChaining", ty: FeatureType::Class(ElementKind::FeatureChaining), many: true, derived: true, default: None },
                FeatureMeta { name: "isPortion", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "isVariable", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "isConstant", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "ownedReferenceSubsetting", ty: FeatureType::Class(ElementKind::ReferenceSubsetting), many: false, derived: true, default: None },
                FeatureMeta { name: "featureTarget", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
                FeatureMeta { name: "crossFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
                FeatureMeta { name: "direction", ty: FeatureType::Enumeration(EnumType::FeatureDirectionKind), many: false, derived: false, default: None },
                FeatureMeta { name: "ownedCrossSubsetting", ty: FeatureType::Class(ElementKind::CrossSubsetting), many: false, derived: true, default: None },
            ],
            ElementKind::FeatureChainExpression => &[
                FeatureMeta { name: "operator", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
                FeatureMeta { name: "targetFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
            ],
            ElementKind::FeatureChaining => &[
                FeatureMeta { name: "chainingFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: false, default: None },
                FeatureMeta { name: "featureChained", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
            ],
            ElementKind::FeatureInverting => &[
                FeatureMeta { name: "featureInverted", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: false, default: None },
                FeatureMeta { name: "invertingFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: false, default: None },
                FeatureMeta { name: "owningFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
            ],
            ElementKind::FeatureMembership => &[
                FeatureMeta { name: "owningType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: true, default: None },
                FeatureMeta { name: "ownedMemberFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
            ...
            ElementKind::FeatureTyping => &[
                FeatureMeta { name: "typedFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: false, default: None },
                FeatureMeta { name: "type", ty: FeatureType::Class(ElementKind::Type), many: false, derived: false, default: None },
                FeatureMeta { name: "owningFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
            ],
            ElementKind::FeatureValue => &[
                FeatureMeta { name: "featureWithValue", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
                FeatureMeta { name: "value", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
                FeatureMeta { name: "isInitial", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "isDefault", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
            ],
            ElementKind::Flow => &[
                FeatureMeta { name: "payloadType", ty: FeatureType::Class(ElementKind::Classifier), many: true, derived: true, default: None },
                FeatureMeta { name: "targetInputFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
                FeatureMeta { name: "sourceOutputFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
                FeatureMeta { name: "flowEnd", ty: FeatureType::Class(ElementKind::FlowEnd), many: true, derived: true, default: None },
                FeatureMeta { name: "payloadFeature", ty: FeatureType::Class(ElementKind::PayloadFeature), many: false, derived: true, default: None },
                FeatureMeta { name: "interaction", ty: FeatureType::Class(ElementKind::Interaction), many: true, derived: true, default: None },
            ],
            ElementKind::FlowDefinition => &[
                FeatureMeta { name: "flowEnd", ty: FeatureType::Class(ElementKind::Usage), many: true, derived: true, default: None },
            ],
            ElementKind::FlowEnd => &[
            ],
            ElementKind::FlowUsage => &[
                FeatureMeta { name: "flowDefinition", ty: FeatureType::Class(ElementKind::Interaction), many: true, derived: true, default: None },
            ],
            ElementKind::ForLoopActionUsage => &[
                FeatureMeta { name: "seqArgument", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
                FeatureMeta { name: "loopVariable", ty: FeatureType::Class(ElementKind::ReferenceUsage), many: false, derived: true, default: None },
            ],
            ElementKind::ForkNode => &[
            ],
            ElementKind::FramedConcernMembership => &[
                FeatureMeta { name: "kind", ty: FeatureType::Enumeration(EnumType::RequirementConstraintKind), many: false, derived: false, default: None },
                FeatureMeta { name: "ownedConcern", ty: FeatureType::Class(ElementKind::ConcernUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "referencedConcern", ty: FeatureType::Class(ElementKind::ConcernUsage), many: false, derived: true, default: None },
            ],
            ElementKind::Function => &[
                FeatureMeta { name: "expression", ty: FeatureType::Class(ElementKind::Expression), many: true, derived: true, default: None },
                FeatureMeta { name: "result", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
                FeatureMeta { name: "isModelLevelEvaluable", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: true, default: Some(false) },
            ],
            ElementKind::IfActionUsage => &[
                FeatureMeta { name: "elseAction", ty: FeatureType::Class(ElementKind::ActionUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "thenAction", ty: FeatureType::Class(ElementKind::ActionUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "ifArgument", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
            ],
            ElementKind::Import => &[
                FeatureMeta { name: "importOwningNamespace", ty: FeatureType::Class(ElementKind::Namespace), many: false, derived: true, default: None },
                FeatureMeta { name: "visibility", ty: FeatureType::Enumeration(EnumType::VisibilityKind), many: false, derived: false, default: None },
                FeatureMeta { name: "isRecursive", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "isImportAll", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "importedElement", ty: FeatureType::Class(ElementKind::Element), many: false, derived: true, default: None },
            ],
            ElementKind::IncludeUseCaseUsage => &[
                FeatureMeta { name: "useCaseIncluded", ty: FeatureType::Class(ElementKind::UseCaseUsage), many: false, derived: true, default: None },
            ],
            ElementKind::IndexExpression => &[
                FeatureMeta { name: "operator", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
            ],
            ElementKind::InstantiationExpression => &[
                FeatureMeta { name: "argument", ty: FeatureType::Class(ElementKind::Expression), many: true, derived: true, default: None },
                FeatureMeta { name: "instantiatedType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: true, default: None },
            ],
            ElementKind::Interaction => &[
            ],
            ElementKind::InterfaceDefinition => &[
                FeatureMeta { name: "interfaceEnd", ty: FeatureType::Class(ElementKind::PortUsage), many: true, derived: true, default: None },
            ],
            ElementKind::InterfaceUsage => &[
                FeatureMeta { name: "interfaceDefinition", ty: FeatureType::Class(ElementKind::InterfaceDefinition), many: true, derived: true, default: None },
            ],
            ElementKind::Intersecting => &[
                FeatureMeta { name: "typeIntersected", ty: FeatureType::Class(ElementKind::Type), many: false, derived: true, default: None },
                FeatureMeta { name: "intersectingType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: false, default: None },
            ],
            ElementKind::Invariant => &[
                FeatureMeta { name: "isNegated", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
            ],
            ElementKind::InvocationExpression => &[
            ],
            ElementKind::ItemDefinition => &[
            ...
            ElementKind::ItemUsage => &[
                FeatureMeta { name: "itemDefinition", ty: FeatureType::Class(ElementKind::Structure), many: true, derived: true, default: None },
            ],
            ElementKind::JoinNode => &[
            ],
            ElementKind::LibraryPackage => &[
                FeatureMeta { name: "isStandard", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
            ],
            ElementKind::LiteralBoolean => &[
                FeatureMeta { name: "value", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
            ],
            ElementKind::LiteralExpression => &[
            ],
            ElementKind::LiteralInfinity => &[
            ...
            ElementKind::LiteralInteger => &[
                FeatureMeta { name: "value", ty: FeatureType::Data(PrimitiveType::Integer), many: false, derived: false, default: None },
            ],
            ElementKind::LiteralRational => &[
                FeatureMeta { name: "value", ty: FeatureType::Data(PrimitiveType::Real), many: false, derived: false, default: None },
            ],
            ElementKind::LiteralString => &[
                FeatureMeta { name: "value", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
            ],
            ElementKind::LoopActionUsage => &[
                FeatureMeta { name: "bodyAction", ty: FeatureType::Class(ElementKind::ActionUsage), many: false, derived: true, default: None },
            ],
            ElementKind::Membership => &[
                FeatureMeta { name: "memberElementId", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: true, default: None },
                FeatureMeta { name: "membershipOwningNamespace", ty: FeatureType::Class(ElementKind::Namespace), many: false, derived: true, default: None },
                FeatureMeta { name: "memberShortName", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
                FeatureMeta { name: "memberElement", ty: FeatureType::Class(ElementKind::Element), many: false, derived: false, default: None },
                FeatureMeta { name: "memberName", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
                FeatureMeta { name: "visibility", ty: FeatureType::Enumeration(EnumType::VisibilityKind), many: false, derived: false, default: None },
            ],
            ElementKind::MembershipExpose => &[
            ],
            ElementKind::MembershipImport => &[
                FeatureMeta { name: "importedMembership", ty: FeatureType::Class(ElementKind::Membership), many: false, derived: false, default: None },
            ],
            ElementKind::MergeNode => &[
            ],
            ElementKind::Metaclass => &[
            ...
            ElementKind::MetadataAccessExpression => &[
                FeatureMeta { name: "referencedElement", ty: FeatureType::Class(ElementKind::Element), many: false, derived: true, default: None },
            ],
            ElementKind::MetadataDefinition => &[
            ],
            ElementKind::MetadataFeature => &[
                FeatureMeta { name: "metaclass", ty: FeatureType::Class(ElementKind::Metaclass), many: false, derived: true, default: None },
            ],
            ElementKind::MetadataUsage => &[
                FeatureMeta { name: "metadataDefinition", ty: FeatureType::Class(ElementKind::Metaclass), many: false, derived: true, default: None },
            ],
            ElementKind::Multiplicity => &[
            ],
            ElementKind::MultiplicityRange => &[
                FeatureMeta { name: "lowerBound", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
                FeatureMeta { name: "upperBound", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
                FeatureMeta { name: "bound", ty: FeatureType::Class(ElementKind::Expression), many: true, derived: true, default: None },
            ],
            ElementKind::Namespace => &[
                FeatureMeta { name: "membership", ty: FeatureType::Class(ElementKind::Membership), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedImport", ty: FeatureType::Class(ElementKind::Import), many: true, derived: true, default: None },
                FeatureMeta { name: "member", ty: FeatureType::Class(ElementKind::Element), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedMember", ty: FeatureType::Class(ElementKind::Element), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedMembership", ty: FeatureType::Class(ElementKind::Membership), many: true, derived: true, default: None },
                FeatureMeta { name: "importedMembership", ty: FeatureType::Class(ElementKind::Membership), many: true, derived: true, default: None },
            ],
            ElementKind::NamespaceExpose => &[
            ],
            ElementKind::NamespaceImport => &[
                FeatureMeta { name: "importedNamespace", ty: FeatureType::Class(ElementKind::Namespace), many: false, derived: false, default: None },
            ],
            ElementKind::NullExpression => &[
            ],
            ElementKind::ObjectiveMembership => &[
                FeatureMeta { name: "ownedObjectiveRequirement", ty: FeatureType::Class(ElementKind::RequirementUsage), many: false, derived: true, default: None },
            ],
            ElementKind::OccurrenceDefinition => &[
                FeatureMeta { name: "isIndividual", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
            ],
            ElementKind::OccurrenceUsage => &[
                FeatureMeta { name: "occurrenceDefinition", ty: FeatureType::Class(ElementKind::Class), many: true, derived: true, default: None },
                FeatureMeta { name: "individualDefinition", ty: FeatureType::Class(ElementKind::OccurrenceDefinition), many: false, derived: true, default: None },
                FeatureMeta { name: "isIndividual", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "portionKind", ty: FeatureType::Enumeration(EnumType::PortionKind), many: false, derived: false, default: None },
            ],
            ElementKind::OperatorExpression => &[
                FeatureMeta { name: "operator", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
            ],
            ElementKind::OwningMembership => &[
                FeatureMeta { name: "ownedMemberElement", ty: FeatureType::Class(ElementKind::Element), many: false, derived: true, default: None },
                FeatureMeta { name: "ownedMemberElementId", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: true, default: None },
                FeatureMeta { name: "ownedMemberShortName", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: true, default: None },
                FeatureMeta { name: "ownedMemberName", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: true, default: None },
            ],
            ElementKind::Package => &[
                FeatureMeta { name: "filterCondition", ty: FeatureType::Class(ElementKind::Expression), many: true, derived: true, default: None },
            ],
            ElementKind::ParameterMembership => &[
                FeatureMeta { name: "ownedMemberParameter", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
            ],
            ElementKind::PartDefinition => &[
            ],
            ElementKind::PartUsage => &[
                FeatureMeta { name: "partDefinition", ty: FeatureType::Class(ElementKind::PartDefinition), many: true, derived: true, default: None },
            ],
            ElementKind::PayloadFeature => &[
            ],
            ElementKind::PerformActionUsage => &[
                FeatureMeta { name: "performedAction", ty: FeatureType::Class(ElementKind::ActionUsage), many: false, derived: true, default: None },
            ],
            ElementKind::PortConjugation => &[
                FeatureMeta { name: "originalPortDefinition", ty: FeatureType::Class(ElementKind::PortDefinition), many: false, derived: false, default: None },
                FeatureMeta { name: "conjugatedPortDefinition", ty: FeatureType::Class(ElementKind::ConjugatedPortDefinition), many: false, derived: true, default: None },
            ],
            ElementKind::PortDefinition => &[
                FeatureMeta { name: "conjugatedPortDefinition", ty: FeatureType::Class(ElementKind::ConjugatedPortDefinition), many: false, derived: true, default: None },
            ],
            ElementKind::PortUsage => &[
                FeatureMeta { name: "portDefinition", ty: FeatureType::Class(ElementKind::PortDefinition), many: true, derived: true, default: None },
            ],
            ElementKind::Predicate => &[
            ],
            ElementKind::Redefinition => &[
                FeatureMeta { name: "redefiningFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: false, default: None },
                FeatureMeta { name: "redefinedFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: false, default: None },
            ],
            ElementKind::ReferenceSubsetting => &[
                FeatureMeta { name: "referencedFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: false, default: None },
                FeatureMeta { name: "referencingFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
            ],
            ElementKind::ReferenceUsage => &[
                FeatureMeta { name: "isReference", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: true, default: Some(true) },
            ],
            ElementKind::Relationship => &[
                FeatureMeta { name: "relatedElement", ty: FeatureType::Class(ElementKind::Element), many: true, derived: true, default: None },
                FeatureMeta { name: "target", ty: FeatureType::Class(ElementKind::Element), many: true, derived: false, default: None },
                FeatureMeta { name: "source", ty: FeatureType::Class(ElementKind::Element), many: true, derived: false, default: None },
                FeatureMeta { name: "owningRelatedElement", ty: FeatureType::Class(ElementKind::Element), many: false, derived: false, default: None },
                FeatureMeta { name: "ownedRelatedElement", ty: FeatureType::Class(ElementKind::Element), many: true, derived: false, default: None },
                FeatureMeta { name: "isImplied", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
            ],
            ElementKind::RenderingDefinition => &[
                FeatureMeta { name: "rendering", ty: FeatureType::Class(ElementKind::RenderingUsage), many: true, derived: true, default: None },
            ],
            ElementKind::RenderingUsage => &[
                FeatureMeta { name: "renderingDefinition", ty: FeatureType::Class(ElementKind::RenderingDefinition), many: false, derived: true, default: None },
            ],
            ElementKind::RequirementConstraintMembership => &[
                FeatureMeta { name: "kind", ty: FeatureType::Enumeration(EnumType::RequirementConstraintKind), many: false, derived: false, default: None },
                FeatureMeta { name: "ownedConstraint", ty: FeatureType::Class(ElementKind::ConstraintUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "referencedConstraint", ty: FeatureType::Class(ElementKind::ConstraintUsage), many: false, derived: true, default: None },
            ],
            ElementKind::RequirementDefinition => &[
                FeatureMeta { name: "reqId", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
                FeatureMeta { name: "text", ty: FeatureType::Data(PrimitiveType::String), many: true, derived: true, default: None },
                FeatureMeta { name: "subjectParameter", ty: FeatureType::Class(ElementKind::Usage), many: false, derived: true, default: None },
                FeatureMeta { name: "actorParameter", ty: FeatureType::Class(ElementKind::PartUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "stakeholderParameter", ty: FeatureType::Class(ElementKind::PartUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "assumedConstraint", ty: FeatureType::Class(ElementKind::ConstraintUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "requiredConstraint", ty: FeatureType::Class(ElementKind::ConstraintUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "framedConcern", ty: FeatureType::Class(ElementKind::ConcernUsage), many: true, derived: true, default: None },
            ],
            ElementKind::RequirementUsage => &[
                FeatureMeta { name: "requirementDefinition", ty: FeatureType::Class(ElementKind::RequirementDefinition), many: false, derived: true, default: None },
                FeatureMeta { name: "reqId", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
                FeatureMeta { name: "text", ty: FeatureType::Data(PrimitiveType::String), many: true, derived: true, default: None },
                FeatureMeta { name: "requiredConstraint", ty: FeatureType::Class(ElementKind::ConstraintUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "assumedConstraint", ty: FeatureType::Class(ElementKind::ConstraintUsage), many: true, derived: true, default: None },
            ...
            ElementKind::RequirementVerificationMembership => &[
                FeatureMeta { name: "ownedRequirement", ty: FeatureType::Class(ElementKind::RequirementUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "kind", ty: FeatureType::Enumeration(EnumType::RequirementConstraintKind), many: false, derived: false, default: None },
                FeatureMeta { name: "verifiedRequirement", ty: FeatureType::Class(ElementKind::RequirementUsage), many: false, derived: true, default: None },
            ],
            ElementKind::ResultExpressionMembership => &[
                FeatureMeta { name: "ownedResultExpression", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
            ],
            ElementKind::ReturnParameterMembership => &[
            ],
            ElementKind::SatisfyRequirementUsage => &[
                FeatureMeta { name: "satisfiedRequirement", ty: FeatureType::Class(ElementKind::RequirementUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "satisfyingFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
            ],
            ElementKind::SelectExpression => &[
                FeatureMeta { name: "operator", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
            ],
            ElementKind::SendActionUsage => &[
                FeatureMeta { name: "receiverArgument", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
                FeatureMeta { name: "payloadArgument", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
                FeatureMeta { name: "senderArgument", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
            ],
            ElementKind::Specialization => &[
                FeatureMeta { name: "owningType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: true, default: None },
                FeatureMeta { name: "general", ty: FeatureType::Class(ElementKind::Type), many: false, derived: false, default: None },
                FeatureMeta { name: "specific", ty: FeatureType::Class(ElementKind::Type), many: false, derived: false, default: None },
            ],
            ElementKind::StakeholderMembership => &[
                FeatureMeta { name: "ownedStakeholderParameter", ty: FeatureType::Class(ElementKind::PartUsage), many: false, derived: true, default: None },
            ],
            ElementKind::StateDefinition => &[
                FeatureMeta { name: "state", ty: FeatureType::Class(ElementKind::StateUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "entryAction", ty: FeatureType::Class(ElementKind::ActionUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "doAction", ty: FeatureType::Class(ElementKind::ActionUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "exitAction", ty: FeatureType::Class(ElementKind::ActionUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "isParallel", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
            ],
            ElementKind::StateSubactionMembership => &[
                FeatureMeta { name: "kind", ty: FeatureType::Enumeration(EnumType::StateSubactionKind), many: false, derived: false, default: None },
                FeatureMeta { name: "action", ty: FeatureType::Class(ElementKind::ActionUsage), many: false, derived: true, default: None },
            ],
            ElementKind::StateUsage => &[
                FeatureMeta { name: "stateDefinition", ty: FeatureType::Class(ElementKind::Behavior), many: true, derived: true, default: None },
                FeatureMeta { name: "entryAction", ty: FeatureType::Class(ElementKind::ActionUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "doAction", ty: FeatureType::Class(ElementKind::ActionUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "exitAction", ty: FeatureType::Class(ElementKind::ActionUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "isParallel", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
            ...
            ElementKind::Step => &[
                FeatureMeta { name: "behavior", ty: FeatureType::Class(ElementKind::Behavior), many: true, derived: true, default: None },
                FeatureMeta { name: "parameter", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
            ],
            ElementKind::Structure => &[
            ],
            ElementKind::Subclassification => &[
                FeatureMeta { name: "superclassifier", ty: FeatureType::Class(ElementKind::Classifier), many: false, derived: false, default: None },
                FeatureMeta { name: "subclassifier", ty: FeatureType::Class(ElementKind::Classifier), many: false, derived: false, default: None },
                FeatureMeta { name: "owningClassifier", ty: FeatureType::Class(ElementKind::Classifier), many: false, derived: true, default: None },
            ],
            ElementKind::SubjectMembership => &[
                FeatureMeta { name: "ownedSubjectParameter", ty: FeatureType::Class(ElementKind::Usage), many: false, derived: true, default: None },
            ],
            ElementKind::Subsetting => &[
                FeatureMeta { name: "subsettedFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: false, default: None },
                FeatureMeta { name: "subsettingFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: false, default: None },
                FeatureMeta { name: "owningFeature", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
            ],
            ElementKind::Succession => &[
            ],
            ...
            ElementKind::TerminateActionUsage => &[
                FeatureMeta { name: "terminatedOccurrenceArgument", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
            ],
            ElementKind::TextualRepresentation => &[
                FeatureMeta { name: "language", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
                FeatureMeta { name: "representedElement", ty: FeatureType::Class(ElementKind::Element), many: false, derived: true, default: None },
                FeatureMeta { name: "body", ty: FeatureType::Data(PrimitiveType::String), many: false, derived: false, default: None },
            ],
            ElementKind::TransitionFeatureMembership => &[
                FeatureMeta { name: "kind", ty: FeatureType::Enumeration(EnumType::TransitionFeatureKind), many: false, derived: false, default: None },
                FeatureMeta { name: "transitionFeature", ty: FeatureType::Class(ElementKind::Step), many: false, derived: true, default: None },
            ],
            ElementKind::TransitionUsage => &[
                FeatureMeta { name: "source", ty: FeatureType::Class(ElementKind::ActionUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "target", ty: FeatureType::Class(ElementKind::ActionUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "triggerAction", ty: FeatureType::Class(ElementKind::AcceptActionUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "guardExpression", ty: FeatureType::Class(ElementKind::Expression), many: true, derived: true, default: None },
                FeatureMeta { name: "effectAction", ty: FeatureType::Class(ElementKind::ActionUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "succession", ty: FeatureType::Class(ElementKind::Succession), many: false, derived: true, default: None },
            ],
            ElementKind::TriggerInvocationExpression => &[
                FeatureMeta { name: "kind", ty: FeatureType::Enumeration(EnumType::TriggerKind), many: false, derived: false, default: None },
            ],
            ElementKind::Type => &[
                FeatureMeta { name: "ownedSpecialization", ty: FeatureType::Class(ElementKind::Specialization), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedFeatureMembership", ty: FeatureType::Class(ElementKind::FeatureMembership), many: true, derived: true, default: None },
                FeatureMeta { name: "feature", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedFeature", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
                FeatureMeta { name: "input", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
                FeatureMeta { name: "output", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
                FeatureMeta { name: "isAbstract", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "inheritedMembership", ty: FeatureType::Class(ElementKind::Membership), many: true, derived: true, default: None },
                FeatureMeta { name: "endFeature", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedEndFeature", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
                FeatureMeta { name: "isSufficient", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
                FeatureMeta { name: "ownedConjugator", ty: FeatureType::Class(ElementKind::Conjugation), many: false, derived: true, default: None },
                FeatureMeta { name: "isConjugated", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: true, default: Some(false) },
                FeatureMeta { name: "inheritedFeature", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
                FeatureMeta { name: "multiplicity", ty: FeatureType::Class(ElementKind::Multiplicity), many: false, derived: true, default: None },
                FeatureMeta { name: "unioningType", ty: FeatureType::Class(ElementKind::Type), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedIntersecting", ty: FeatureType::Class(ElementKind::Intersecting), many: true, derived: true, default: None },
                FeatureMeta { name: "intersectingType", ty: FeatureType::Class(ElementKind::Type), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedUnioning", ty: FeatureType::Class(ElementKind::Unioning), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedDisjoining", ty: FeatureType::Class(ElementKind::Disjoining), many: true, derived: true, default: None },
                FeatureMeta { name: "featureMembership", ty: FeatureType::Class(ElementKind::FeatureMembership), many: true, derived: true, default: None },
                FeatureMeta { name: "differencingType", ty: FeatureType::Class(ElementKind::Type), many: true, derived: true, default: None },
                FeatureMeta { name: "ownedDifferencing", ty: FeatureType::Class(ElementKind::Differencing), many: true, derived: true, default: None },
                FeatureMeta { name: "directedFeature", ty: FeatureType::Class(ElementKind::Feature), many: true, derived: true, default: None },
            ],
            ElementKind::TypeFeaturing => &[
                FeatureMeta { name: "featureOfType", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: false, default: None },
                FeatureMeta { name: "featuringType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: false, default: None },
                FeatureMeta { name: "owningFeatureOfType", ty: FeatureType::Class(ElementKind::Feature), many: false, derived: true, default: None },
            ],
            ElementKind::Unioning => &[
                FeatureMeta { name: "typeUnioned", ty: FeatureType::Class(ElementKind::Type), many: false, derived: true, default: None },
                FeatureMeta { name: "unioningType", ty: FeatureType::Class(ElementKind::Type), many: false, derived: false, default: None },
            ],
            ElementKind::Usage => &[
                FeatureMeta { name: "mayTimeVary", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: true, default: Some(false) },
                FeatureMeta { name: "isReference", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: true, default: Some(false) },
                FeatureMeta { name: "variant", ty: FeatureType::Class(ElementKind::Usage), many: true, derived: true, default: None },
                FeatureMeta { name: "variantMembership", ty: FeatureType::Class(ElementKind::VariantMembership), many: true, derived: true, default: None },
                FeatureMeta { name: "owningDefinition", ty: FeatureType::Class(ElementKind::Definition), many: false, derived: true, default: None },
                FeatureMeta { name: "owningUsage", ty: FeatureType::Class(ElementKind::Usage), many: false, derived: true, default: None },
                FeatureMeta { name: "definition", ty: FeatureType::Class(ElementKind::Classifier), many: true, derived: true, default: None },
                FeatureMeta { name: "usage", ty: FeatureType::Class(ElementKind::Usage), many: true, derived: true, default: None },
                FeatureMeta { name: "directedUsage", ty: FeatureType::Class(ElementKind::Usage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedUsage", ty: FeatureType::Class(ElementKind::Usage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedReference", ty: FeatureType::Class(ElementKind::ReferenceUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedAttribute", ty: FeatureType::Class(ElementKind::AttributeUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedEnumeration", ty: FeatureType::Class(ElementKind::EnumerationUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedOccurrence", ty: FeatureType::Class(ElementKind::OccurrenceUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedItem", ty: FeatureType::Class(ElementKind::ItemUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedPart", ty: FeatureType::Class(ElementKind::PartUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedPort", ty: FeatureType::Class(ElementKind::PortUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedConnection", ty: FeatureType::Class(ElementKind::ConnectorAsUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedFlow", ty: FeatureType::Class(ElementKind::FlowUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedInterface", ty: FeatureType::Class(ElementKind::InterfaceUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedAllocation", ty: FeatureType::Class(ElementKind::AllocationUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedAction", ty: FeatureType::Class(ElementKind::ActionUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedState", ty: FeatureType::Class(ElementKind::StateUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedTransition", ty: FeatureType::Class(ElementKind::TransitionUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedCalculation", ty: FeatureType::Class(ElementKind::CalculationUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedConstraint", ty: FeatureType::Class(ElementKind::ConstraintUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedRequirement", ty: FeatureType::Class(ElementKind::RequirementUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedConcern", ty: FeatureType::Class(ElementKind::ConcernUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedCase", ty: FeatureType::Class(ElementKind::CaseUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedAnalysisCase", ty: FeatureType::Class(ElementKind::AnalysisCaseUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedVerificationCase", ty: FeatureType::Class(ElementKind::VerificationCaseUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedUseCase", ty: FeatureType::Class(ElementKind::UseCaseUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedView", ty: FeatureType::Class(ElementKind::ViewUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedViewpoint", ty: FeatureType::Class(ElementKind::ViewpointUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedRendering", ty: FeatureType::Class(ElementKind::RenderingUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "nestedMetadata", ty: FeatureType::Class(ElementKind::MetadataUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "isVariation", ty: FeatureType::Data(PrimitiveType::Boolean), many: false, derived: false, default: Some(false) },
            ],
            ElementKind::UseCaseDefinition => &[
                FeatureMeta { name: "includedUseCase", ty: FeatureType::Class(ElementKind::UseCaseUsage), many: true, derived: true, default: None },
            ],
            ElementKind::UseCaseUsage => &[
                FeatureMeta { name: "useCaseDefinition", ty: FeatureType::Class(ElementKind::UseCaseDefinition), many: false, derived: true, default: None },
                FeatureMeta { name: "includedUseCase", ty: FeatureType::Class(ElementKind::UseCaseUsage), many: true, derived: true, default: None },
            ],
            ElementKind::VariantMembership => &[
                FeatureMeta { name: "ownedVariantUsage", ty: FeatureType::Class(ElementKind::Usage), many: false, derived: true, default: None },
            ],
            ElementKind::VerificationCaseDefinition => &[
                FeatureMeta { name: "verifiedRequirement", ty: FeatureType::Class(ElementKind::RequirementUsage), many: true, derived: true, default: None },
            ],
            ElementKind::VerificationCaseUsage => &[
                FeatureMeta { name: "verificationCaseDefinition", ty: FeatureType::Class(ElementKind::VerificationCaseDefinition), many: false, derived: true, default: None },
                FeatureMeta { name: "verifiedRequirement", ty: FeatureType::Class(ElementKind::RequirementUsage), many: true, derived: true, default: None },
            ],
            ElementKind::ViewDefinition => &[
                FeatureMeta { name: "view", ty: FeatureType::Class(ElementKind::ViewUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "satisfiedViewpoint", ty: FeatureType::Class(ElementKind::ViewpointUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "viewRendering", ty: FeatureType::Class(ElementKind::RenderingUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "viewCondition", ty: FeatureType::Class(ElementKind::Expression), many: true, derived: true, default: None },
            ],
            ElementKind::ViewRenderingMembership => &[
                FeatureMeta { name: "ownedRendering", ty: FeatureType::Class(ElementKind::RenderingUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "referencedRendering", ty: FeatureType::Class(ElementKind::RenderingUsage), many: false, derived: true, default: None },
            ],
            ElementKind::ViewUsage => &[
                FeatureMeta { name: "viewDefinition", ty: FeatureType::Class(ElementKind::ViewDefinition), many: false, derived: true, default: None },
                FeatureMeta { name: "satisfiedViewpoint", ty: FeatureType::Class(ElementKind::ViewpointUsage), many: true, derived: true, default: None },
                FeatureMeta { name: "exposedElement", ty: FeatureType::Class(ElementKind::Element), many: true, derived: true, default: None },
                FeatureMeta { name: "viewRendering", ty: FeatureType::Class(ElementKind::RenderingUsage), many: false, derived: true, default: None },
                FeatureMeta { name: "viewCondition", ty: FeatureType::Class(ElementKind::Expression), many: true, derived: true, default: None },
            ],
            ElementKind::ViewpointDefinition => &[
                FeatureMeta { name: "viewpointStakeholder", ty: FeatureType::Class(ElementKind::PartUsage), many: true, derived: true, default: None },
            ],
            ElementKind::ViewpointUsage => &[
                FeatureMeta { name: "viewpointDefinition", ty: FeatureType::Class(ElementKind::ViewpointDefinition), many: false, derived: true, default: None },
                FeatureMeta { name: "viewpointStakeholder", ty: FeatureType::Class(ElementKind::PartUsage), many: true, derived: true, default: None },
            ],
            ElementKind::WhileLoopActionUsage => &[
                FeatureMeta { name: "whileArgument", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
                FeatureMeta { name: "untilArgument", ty: FeatureType::Class(ElementKind::Expression), many: false, derived: true, default: None },
            ],
        }
    }
